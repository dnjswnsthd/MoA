<template>
    <v-dialog v-model="dialog" persistent max-width="500">
        ...
        <v-card class="px-5">
            ...
            <v-card-text>
                Name : <v-text-field v-model="modSprint.sprint_name"></v-text-field>
                Subject : <v-text-field v-model="modSprint.sprint_subject"></v-text-field>
                startDate : <v-text-field v-model="modSprint.sprint_start_date" type="date"></v-text-field>
                endDate : <v-text-field v-model="modSprint.sprint_end_date" type="date"></v-text-field>
                Description : <v-textarea v-model="modSprint.sprint_description"></v-textarea>
            </v-card-text>
            <v-card-actions>
                <v-spacer></v-spacer>
